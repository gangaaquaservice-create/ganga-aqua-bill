    ...
    st.session_state["items"] = [
        {
            "qty": 3,
            "rate": 150,
            "description": "1 litr BISLERI Mineral water"
        },
        {
            "qty": 3,
            "rate": 210,
            "description": "500ml. BISLERI Mineral water"
        },
        {
            "qty": 3,
            "rate": 250,
            "description": "200ml BISLERI Mineral water"
        }
    ]
...
for i in range(len(st.session_state["items"])):
    ...
    # Save current values
    st.session_state["items"][i]["qty"] = qty
    st.session_state["items"][i]["rate"] = rate
    st.session_state["items"][i]["description"] = description
...
def generate_pdf():
    ...
    # Customer name may be long, so use a smaller font
    pdf.set_font(
        "Helvetica",
        size=8
    )
